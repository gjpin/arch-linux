...
sudo -u ${NEW_USER} kwriteconfig5 --file kwinrulesrc --group General --key count "6"
sudo -u ${NEW_USER} kwriteconfig5 --file kwinrulesrc --group General --key rules "1,2,3,4,5,6"
...
sudo -u ${NEW_USER} kwriteconfig5 --file kwinrulesrc --group 1 --key wmclass "code-oss"
